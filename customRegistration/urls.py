...
urlpatterns = [
    ...
    path('candidates/search/', views.search_view, name='candidates_search'),
    path('candidates_list/<int:id>', views.candidate_detailed_view, name='candidates_list_detailed'),
]